# # Pytorch (線性回歸圖形 Linear regression)===============================
# # y = 2x + 1 <= 做為本次的設定
...
class LinerRegressionModel(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(LinerRegressionModel, self).__init__()    # y = (2)x + (1)
        self.linear= nn.Linear(input_dim, output_dim)   # 全連接層,給定 x, y 訓練出 w, b, 使 y = (w)x + (b)
